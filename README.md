...
![Category](https://img.shields.io/badge/Category-Code%20%26%20Dev-fa1e4e?style=for-the-badge)
![Tech](https://img.shields.io/badge/Stack-HTML5%20%7C%20JSON-00ff88?style=for-the-badge)
![Lines](https://img.shields.io/badge/Lines-1061-ffb800?style=for-the-badge)
...
```mermaid
graph TB
    A[Security Scanner] --> B[index.html]
    A --> C[style.css]
    A --> D[script.js]
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-security-scanner.git

# Oeffnen
cd dkz-security-scanner
